...
| `[[ SLOP v1.3 ]]` | Schema header. Contains the full rule set for the session. | ![#1589F0](https://placehold.co/15x15/1589F0/1589F0.png) `#1589F0` | ![#1270C0](https://placehold.co/15x15/1270C0/1270C0.png) `#1270C0` |
...
|---|---|---|---|
| `SET [VAR] = [value]` | Store a named value for the session. | ![#2ECC71](https://placehold.co/15x15/2ECC71/2ECC71.png) `#2ECC71` | ![#27AE60](https://placehold.co/15x15/27AE60/27AE60.png) `#27AE60` |
| `RECALL [VAR]` | Read and apply the current value of the named variable. | ![#2ECC71](https://placehold.co/15x15/2ECC71/2ECC71.png) `#2ECC71` | ![#27AE60](https://placehold.co/15x15/27AE60/27AE60.png) `#27AE60` |
| `DEFAULT: [VAR] = [value]` | Use this value if the variable has not been explicitly set. | ![#2ECC71](https://placehold.co/15x15/2ECC71/2ECC71.png) `#2ECC71` | ![#27AE60](https://placehold.co/15x15/27AE60/27AE60.png) `#27AE60` |
